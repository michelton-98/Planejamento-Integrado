...
export default function PendenciasPorDisciplina({ rows, dataReferencia }) {
  ...
  return (
    <Card faixaCor="#2f6fed" categoria="Ranking" titulo="Pendências por Disciplina">
            ...
            <li key={item.disciplina}>
              ...
              >
                <div className="mb-1 flex items-center justify-between text-sm">
                  <span className="text-navy">{item.disciplina}</span>
      ...
      {disciplinaSelecionada && (
        <div className="mt-4 overflow-x-auto rounded-lg border border-gray-200 print:hidden">
          ...
          <table className="min-w-full divide-y divide-gray-200 text-sm">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-3 py-2 text-left font-medium text-gray-500">Empresa - Escopo</th>
